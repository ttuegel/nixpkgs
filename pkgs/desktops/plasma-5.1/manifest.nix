...
[
  {
    name = stdenv.lib.nameFromURL "kwayland-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "milou-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "plasma-workspace-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kdeplasma-addons-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "khotkeys-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kde-cli-tools-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "libnm-qt-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "oxygen-fonts-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "khelpcenter-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kmenuedit-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kinfocenter-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kwrited-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kio-extras-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "systemsettings-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "powerdevil-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "plasma-desktop-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "libmm-qt-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "breeze-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "ksysguard-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kwin-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "oxygen-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "libkscreen-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "libksysguard-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "plasma-workspace-wallpapers-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "kfilemetadata-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "plasma-nm-5.1.2.tar.xz" ".tar";
    src = fetchurl {
  ...
  {
    name = stdenv.lib.nameFromURL "baloo-5.1.2.tar.xz" ".tar";
    src = fetchurl {
